...
static char ymrobot_msgs__msg__NavPoint__FIELD_NAME__seq[] = "seq";
static char ymrobot_msgs__msg__NavPoint__FIELD_NAME__position[] = "position";
static char ymrobot_msgs__msg__NavPoint__FIELD_NAME__nav_name[] = "nav_name";
static char ymrobot_msgs__msg__NavPoint__FIELD_NAME__nav_map_name[] = "nav_map_name";
static char ymrobot_msgs__msg__NavPoint__FIELD_NAME__map_index[] = "map_index";

static rosidl_runtime_c__type_description__Field ymrobot_msgs__msg__NavPoint__FIELDS[] = {
  {
    {ymrobot_msgs__msg__NavPoint__FIELD_NAME__seq, 3, 3},
    {
  ...
  {
    {ymrobot_msgs__msg__NavPoint__FIELD_NAME__position, 8, 8},
    {
  ...
  {
    {ymrobot_msgs__msg__NavPoint__FIELD_NAME__nav_name, 8, 8},
    {
  ...
  {
    {ymrobot_msgs__msg__NavPoint__FIELD_NAME__nav_map_name, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {ymrobot_msgs__msg__NavPoint__FIELD_NAME__map_index, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ymrobot_msgs__msg__NavPoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ymrobot_msgs__msg__NavPoint__FIELDS, 5, 5},
    },
    {ymrobot_msgs__msg__NavPoint__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
ymrobot_msgs__msg__NavPoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ymrobot_msgs__msg__NavPoint__get_individual_type_description_source(NULL),
