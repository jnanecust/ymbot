...
#include "ymrobot_msgs/msg/detail/map_task_command__type_support.h"
...
static const _MapTaskCommand_type_support_symbol_names_t _MapTaskCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, msg, MapTaskCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, msg, MapTaskCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, msg, MapTaskCommand)() {
  return &::ymrobot_msgs::msg::rosidl_typesupport_c::MapTaskCommand_message_type_support_handle;
}
