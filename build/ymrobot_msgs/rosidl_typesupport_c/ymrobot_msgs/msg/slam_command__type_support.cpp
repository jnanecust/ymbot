...
#include "ymrobot_msgs/msg/detail/slam_command__type_support.h"
...
static const _SlamCommand_type_support_symbol_names_t _SlamCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, msg, SlamCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, msg, SlamCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, msg, SlamCommand)() {
  return &::ymrobot_msgs::msg::rosidl_typesupport_c::SlamCommand_message_type_support_handle;
}
