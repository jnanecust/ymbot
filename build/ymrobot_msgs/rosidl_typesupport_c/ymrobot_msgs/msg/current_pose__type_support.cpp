...
#include "ymrobot_msgs/msg/detail/current_pose__type_support.h"
...
static const _CurrentPose_type_support_symbol_names_t _CurrentPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, msg, CurrentPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, msg, CurrentPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, msg, CurrentPose)() {
  return &::ymrobot_msgs::msg::rosidl_typesupport_c::CurrentPose_message_type_support_handle;
}
