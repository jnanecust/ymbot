...
#include "ymrobot_msgs/srv/detail/humanoid_upper_limb__type_support.h"
...
static const _HumanoidUpperLimb_Request_type_support_symbol_names_t _HumanoidUpperLimb_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, srv, HumanoidUpperLimb_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, srv, HumanoidUpperLimb_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, srv, HumanoidUpperLimb_Request)() {
  return &::ymrobot_msgs::srv::rosidl_typesupport_c::HumanoidUpperLimb_Request_message_type_support_handle;
}
...
static const _HumanoidUpperLimb_Response_type_support_symbol_names_t _HumanoidUpperLimb_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, srv, HumanoidUpperLimb_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, srv, HumanoidUpperLimb_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, srv, HumanoidUpperLimb_Response)() {
  return &::ymrobot_msgs::srv::rosidl_typesupport_c::HumanoidUpperLimb_Response_message_type_support_handle;
}
...
static const _HumanoidUpperLimb_Event_type_support_symbol_names_t _HumanoidUpperLimb_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, srv, HumanoidUpperLimb_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, srv, HumanoidUpperLimb_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, srv, HumanoidUpperLimb_Event)() {
  return &::ymrobot_msgs::srv::rosidl_typesupport_c::HumanoidUpperLimb_Event_message_type_support_handle;
}
...
static const _HumanoidUpperLimb_type_support_symbol_names_t _HumanoidUpperLimb_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ymrobot_msgs, srv, HumanoidUpperLimb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ymrobot_msgs, srv, HumanoidUpperLimb)),
  }
};
...
static const rosidl_service_type_support_t HumanoidUpperLimb_service_type_support_handle = {
  ...
  &HumanoidUpperLimb_Request_message_type_support_handle,
  &HumanoidUpperLimb_Response_message_type_support_handle,
  &HumanoidUpperLimb_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ymrobot_msgs, srv, HumanoidUpperLimb)() {
  return &::ymrobot_msgs::srv::rosidl_typesupport_c::HumanoidUpperLimb_service_type_support_handle;
}
