...
#include "ymrobot_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // params, params_code
#include "rosidl_runtime_c/string_functions.h"  // params, params_code

// forward declare type support functions


using _Command__ros_msg_type = ymrobot_msgs__msg__Command;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->params_code;
  ...
  ymrobot_msgs__msg__Command * ros_message)
{
  ...
  // Field name: params_code
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->params_code.data) {
      rosidl_runtime_c__String__init(&ros_message->params_code);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->params_code,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'params_code'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs__msg__Command;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ymrobot_msgs__msg__Command * ros_message = static_cast<const ymrobot_msgs__msg__Command *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ymrobot_msgs__msg__Command(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ymrobot_msgs__msg__Command * ros_message = static_cast<ymrobot_msgs__msg__Command *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ymrobot_msgs__msg__Command(cdr, ros_message);
}

static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ymrobot_msgs__msg__Command(
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ymrobot_msgs__msg__Command(
