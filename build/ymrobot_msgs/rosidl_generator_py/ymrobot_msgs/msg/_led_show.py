...
class Metaclass_LedShow(type):
    """Metaclass of message 'LedShow'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ymrobot_msgs.msg.LedShow')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__led_show
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__led_show
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__led_show
            cls._TYPE_SUPPORT = module.type_support_msg__msg__led_show
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__led_show
...
class LedShow(metaclass=Metaclass_LedShow):
    """Message class 'LedShow'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.luminance = kwargs.get('luminance', int())
    ...
    def luminance(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'luminance' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'luminance' field must be an unsigned integer in [0, 255]"
