...
bool ymrobot_msgs__msg__control_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ymrobot_msgs.msg._control_mode.ControlMode", full_classname_dest, 42) == 0);
  }
  ymrobot_msgs__msg__ControlMode * ros_message = _ros_message;
  {  // code
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ymrobot_msgs__msg__control_mode__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ControlMode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ymrobot_msgs.msg._control_mode");
  ...
  ymrobot_msgs__msg__ControlMode * ros_message = (ymrobot_msgs__msg__ControlMode *)raw_ros_message;
  {  // code
    PyObject * field = NULL;
