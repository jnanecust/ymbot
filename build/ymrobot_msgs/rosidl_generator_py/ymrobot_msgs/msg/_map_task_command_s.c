...
bool ymrobot_msgs__msg__map_task_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ymrobot_msgs.msg._map_task_command.MapTaskCommand", full_classname_dest, 49) == 0);
  }
  ymrobot_msgs__msg__MapTaskCommand * ros_message = _ros_message;
  {  // code
...
{
  /* NOTE(esteve): Call constructor of MapTaskCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ymrobot_msgs.msg._map_task_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MapTaskCommand");
  ...
  ymrobot_msgs__msg__MapTaskCommand * ros_message = (ymrobot_msgs__msg__MapTaskCommand *)raw_ros_message;
  {  // code
    PyObject * field = NULL;
