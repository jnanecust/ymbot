...
bool ymrobot_msgs__msg__task_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ymrobot_msgs.msg._task_status.TaskStatus", full_classname_dest, 40) == 0);
  }
  ymrobot_msgs__msg__TaskStatus * ros_message = _ros_message;
  {  // amr_id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ymrobot_msgs__msg__task_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TaskStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ymrobot_msgs.msg._task_status");
  ...
  ymrobot_msgs__msg__TaskStatus * ros_message = (ymrobot_msgs__msg__TaskStatus *)raw_ros_message;
  {  // amr_id
    PyObject * field = NULL;
