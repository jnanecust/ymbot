...
bool ymrobot_msgs__msg__current_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ymrobot_msgs.msg._current_pose.CurrentPose", full_classname_dest, 42) == 0);
  }
  ymrobot_msgs__msg__CurrentPose * ros_message = _ros_message;
  {  // x
  ...
  {  // rw
    ...
    assert(PyFloat_Check(field));
    ros_message->rw = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ymrobot_msgs__msg__current_pose__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CurrentPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ymrobot_msgs.msg._current_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CurrentPose");
  ...
  ymrobot_msgs__msg__CurrentPose * ros_message = (ymrobot_msgs__msg__CurrentPose *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
