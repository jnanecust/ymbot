...
class Metaclass_ControlMode(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'SHOU_DONG': cls.__constants['SHOU_DONG'],
            'SHOU_DONG_CLOUD': cls.__constants['SHOU_DONG_CLOUD'],
            'AUTO': cls.__constants['AUTO'],
            'PID': cls.__constants['PID'],
        }

    @property
    def SHOU_DONG(self):
        """Message constant 'SHOU_DONG'."""
        return Metaclass_ControlMode.__constants['SHOU_DONG']

    @property
    def SHOU_DONG_CLOUD(self):
        """Message constant 'SHOU_DONG_CLOUD'."""
        return Metaclass_ControlMode.__constants['SHOU_DONG_CLOUD']

    @property
    def AUTO(self):
        """Message constant 'AUTO'."""
        return Metaclass_ControlMode.__constants['AUTO']

    @property
    def PID(self):
        """Message constant 'PID'."""
        return Metaclass_ControlMode.__constants['PID']
