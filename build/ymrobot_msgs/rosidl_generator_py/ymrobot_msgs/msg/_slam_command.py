...
class SlamCommand(metaclass=Metaclass_SlamCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.mapping = kwargs.get('mapping', str())
        self.relocalize = kwargs.get('relocalize', str())
        self.start = kwargs.get('start', str())
        self.stop = kwargs.get('stop', str())
    ...
    def __eq__(self, other):
        ...
        if self.mapping != other.mapping:
            return False
        if self.relocalize != other.relocalize:
            return False
    ...
    def mapping(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'mapping' field must be of type 'str'"
        self._mapping = value

    @builtins.property
    def relocalize(self):
        """Message field 'relocalize'."""
        return self._relocalize

    @relocalize.setter
    def relocalize(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'relocalize' field must be of type 'str'"
        self._relocalize = value
    ...
    def start(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'start' field must be of type 'str'"
        self._start = value
    ...
    def stop(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'stop' field must be of type 'str'"
        self._stop = value
