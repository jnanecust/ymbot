...
class Metaclass_CurrentPose(type):
    """Metaclass of message 'CurrentPose'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ymrobot_msgs.msg.CurrentPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__current_pose
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__current_pose
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__current_pose
            cls._TYPE_SUPPORT = module.type_support_msg__msg__current_pose
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__current_pose
...
class CurrentPose(metaclass=Metaclass_CurrentPose):
    """Message class 'CurrentPose'."""
    ...
    def rw(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'rw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._rw = value
