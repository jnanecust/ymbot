...
bool ymrobot_msgs__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ymrobot_msgs.msg._command.Command", full_classname_dest, 33) == 0);
  }
  ymrobot_msgs__msg__Command * ros_message = _ros_message;
  {  // code
  ...
  {  // params_code
    PyObject * field = PyObject_GetAttrString(_pymsg, "params_code");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->params_code, PyBytes_AS_STRING(encoded_field));
  ...
  {  // params
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->params.data;
...
PyObject * ymrobot_msgs__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ymrobot_msgs.msg._command");
  ...
  ymrobot_msgs__msg__Command * ros_message = (ymrobot_msgs__msg__Command *)raw_ros_message;
  {  // code
    PyObject * field = NULL;
  ...
  {  // params_code
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->params_code.data,
      strlen(ros_message->params_code.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "params_code", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // params
    ...
    rosidl_runtime_c__String * src = ros_message->params.data;
