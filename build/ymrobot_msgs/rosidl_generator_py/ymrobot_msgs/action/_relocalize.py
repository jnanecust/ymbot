    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize_Goal')
            logger.debug(
...
class Relocalize_Goal(metaclass=Metaclass_Relocalize_Goal):
    ...
    _fields_and_field_types = {
        'pcd_path': 'string',
        'init_pose_list': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.init_pose_list = array.array('d', kwargs.get('init_pose_list', []))
    ...
    def __eq__(self, other):
        ...
        if self.pcd_path != other.pcd_path:
            return False
        if self.init_pose_list != other.init_pose_list:
            return False
        return True
    ...
    @builtins.property
    def init_pose_list(self):
        """Message field 'init_pose_list'."""
        return self._init_pose_list

    @init_pose_list.setter
    def init_pose_list(self, value):
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'd', \
                    "The 'init_pose_list' array.array() must have the type code of 'd'"
                self._init_pose_list = value
                return
            ...
            assert \
                ...
                "The 'init_pose_list' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._init_pose_list = array.array('d', value)
...
class Metaclass_Relocalize_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Relocalize_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Relocalize_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ymrobot_msgs.action import Relocalize
...
class Relocalize_SendGoal_Request(metaclass=Metaclass_Relocalize_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ymrobot_msgs/Relocalize_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ymrobot_msgs.action._relocalize import Relocalize_Goal
...
class Metaclass_Relocalize_SendGoal_Event(type):
    """Metaclass of message 'Relocalize_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__relocalize__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__relocalize__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__relocalize__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__relocalize__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__relocalize__send_goal__event
...
class Relocalize_SendGoal_Event(metaclass=Metaclass_Relocalize_SendGoal_Event):
    """Message class 'Relocalize_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ymrobot_msgs/Relocalize_SendGoal_Request, 1>',
        'response': 'sequence<ymrobot_msgs/Relocalize_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ymrobot_msgs.action import Relocalize_SendGoal_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Relocalize_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Relocalize_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ymrobot_msgs.action import Relocalize_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Relocalize_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Relocalize_SendGoal_Response'"
...
class Metaclass_Relocalize_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ymrobot_msgs.action import _relocalize
            ...
            if _relocalize.Metaclass_Relocalize_SendGoal_Event._TYPE_SUPPORT is None:
                _relocalize.Metaclass_Relocalize_SendGoal_Event.__import_type_support__()


class Relocalize_SendGoal(metaclass=Metaclass_Relocalize_SendGoal):
    from ymrobot_msgs.action._relocalize import Relocalize_SendGoal_Request as Request
    from ymrobot_msgs.action._relocalize import Relocalize_SendGoal_Response as Response
    from ymrobot_msgs.action._relocalize import Relocalize_SendGoal_Event as Event
...
class Relocalize_GetResult_Response(metaclass=Metaclass_Relocalize_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ymrobot_msgs/Relocalize_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ymrobot_msgs.action._relocalize import Relocalize_Result
...
class Metaclass_Relocalize_GetResult_Event(type):
    """Metaclass of message 'Relocalize_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__relocalize__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__relocalize__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__relocalize__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__relocalize__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__relocalize__get_result__event
...
class Relocalize_GetResult_Event(metaclass=Metaclass_Relocalize_GetResult_Event):
    """Message class 'Relocalize_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<ymrobot_msgs/Relocalize_GetResult_Request, 1>',
        'response': 'sequence<ymrobot_msgs/Relocalize_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ymrobot_msgs.action import Relocalize_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Relocalize_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Relocalize_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ymrobot_msgs.action import Relocalize_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Relocalize_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Relocalize_GetResult_Response'"
        self._response = value
...
class Metaclass_Relocalize_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _relocalize.Metaclass_Relocalize_GetResult_Event._TYPE_SUPPORT is None:
                _relocalize.Metaclass_Relocalize_GetResult_Event.__import_type_support__()


class Relocalize_GetResult(metaclass=Metaclass_Relocalize_GetResult):
    from ymrobot_msgs.action._relocalize import Relocalize_GetResult_Request as Request
    from ymrobot_msgs.action._relocalize import Relocalize_GetResult_Response as Response
    from ymrobot_msgs.action._relocalize import Relocalize_GetResult_Event as Event
...
class Metaclass_Relocalize_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Relocalize_FeedbackMessage(metaclass=Metaclass_Relocalize_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ymrobot_msgs/Relocalize_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ymrobot_msgs', 'action'], 'Relocalize_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ymrobot_msgs.action._relocalize import Relocalize_Feedback
...
class Metaclass_Relocalize(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ymrobot_msgs.action.Relocalize')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Relocalize(metaclass=Metaclass_Relocalize):
    ...
    from ymrobot_msgs.action._relocalize import Relocalize_Goal as Goal
    # The result message defined in the action definition.
    from ymrobot_msgs.action._relocalize import Relocalize_Result as Result
    # The feedback message defined in the action definition.
    from ymrobot_msgs.action._relocalize import Relocalize_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ymrobot_msgs.action._relocalize import Relocalize_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ymrobot_msgs.action._relocalize import Relocalize_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ymrobot_msgs.action._relocalize import Relocalize_FeedbackMessage as FeedbackMessage
