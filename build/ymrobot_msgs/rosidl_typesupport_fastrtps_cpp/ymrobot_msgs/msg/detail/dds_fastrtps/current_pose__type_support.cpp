...
#include "ymrobot_msgs/msg/detail/current_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ymrobot_msgs::msg::CurrentPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ymrobot_msgs::msg::CurrentPose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs::msg::CurrentPose;
    is_plain =
      (
      offsetof(DataType, rw) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::CurrentPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ymrobot_msgs::msg::CurrentPose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CurrentPose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::CurrentPose *>(
...
static size_t _CurrentPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CurrentPose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CurrentPose__callbacks = {
  "ymrobot_msgs::msg",
  "CurrentPose",
...
static rosidl_message_type_support_t _CurrentPose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CurrentPose__callbacks,
...
get_message_type_support_handle<ymrobot_msgs::msg::CurrentPose>()
{
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_CurrentPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ymrobot_msgs, msg, CurrentPose)() {
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_CurrentPose__handle;
}
