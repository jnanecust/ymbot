...
#include "ymrobot_msgs/msg/detail/slam_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ymrobot_msgs::msg::SlamCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ymrobot_msgs::msg::SlamCommand & ros_message)
{
  // Member: mapping
  cdr >> ros_message.mapping;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs::msg::SlamCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ymrobot_msgs
max_serialized_size_key_SlamCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::SlamCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ymrobot_msgs::msg::SlamCommand *>(
    untyped_ros_message);
...
{
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_SlamCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ymrobot_msgs, msg, SlamCommand)() {
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_SlamCommand__handle;
}
