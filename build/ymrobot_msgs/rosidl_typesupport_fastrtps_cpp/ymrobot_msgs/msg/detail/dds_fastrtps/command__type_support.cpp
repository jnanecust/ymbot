...
#include "ymrobot_msgs/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ymrobot_msgs::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ymrobot_msgs::msg::Command & ros_message)
{
  // Member: code
  cdr >> ros_message.code;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    ...
    (ros_message.params_code.size() + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ymrobot_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ymrobot_msgs, msg, Command)() {
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
