...
#include "ymrobot_msgs/msg/detail/control_mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs::msg::ControlMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::ControlMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ymrobot_msgs::msg::ControlMode *>(
    untyped_ros_message);
...
{
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_ControlMode__handle;
}
