...
#include "ymrobot_msgs/msg/detail/image_video__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ymrobot_msgs::msg::ImageVideo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ymrobot_msgs::msg::ImageVideo & ros_message)
{
  // Member: camera_task_type
  cdr >> ros_message.camera_task_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs::msg::ImageVideo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::ImageVideo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ymrobot_msgs::msg::ImageVideo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImageVideo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::ImageVideo *>(
...
static size_t _ImageVideo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImageVideo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImageVideo__callbacks = {
  "ymrobot_msgs::msg",
  "ImageVideo",
...
static rosidl_message_type_support_t _ImageVideo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImageVideo__callbacks,
...
{
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_ImageVideo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ymrobot_msgs, msg, ImageVideo)() {
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_ImageVideo__handle;
}
