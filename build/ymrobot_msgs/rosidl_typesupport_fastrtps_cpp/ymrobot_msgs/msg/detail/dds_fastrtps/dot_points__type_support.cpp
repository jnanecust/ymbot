...
#include "ymrobot_msgs/msg/detail/dot_points__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ymrobot_msgs::msg::DotPoints & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ymrobot_msgs::msg::DotPoints & ros_message)
{
  // Member: action
  cdr >> ros_message.action;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ymrobot_msgs::msg::DotPoints;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::DotPoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ymrobot_msgs::msg::DotPoints *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DotPoints__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ymrobot_msgs::msg::DotPoints *>(
...
static size_t _DotPoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DotPoints(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DotPoints__callbacks = {
  "ymrobot_msgs::msg",
  "DotPoints",
...
static rosidl_message_type_support_t _DotPoints__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DotPoints__callbacks,
...
{
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_DotPoints__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ymrobot_msgs, msg, DotPoints)() {
  return &ymrobot_msgs::msg::typesupport_fastrtps_cpp::_DotPoints__handle;
}
