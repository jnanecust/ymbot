  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = orbbec_camera_msgs::srv::GetDeviceInfo_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = orbbec_camera_msgs::srv::GetDeviceInfo_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        orbbec_camera_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_DeviceInfo(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
// functions for orbbec_camera_msgs::srv::GetDeviceInfo_Request already declared above

// functions for orbbec_camera_msgs::srv::GetDeviceInfo_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_orbbec_camera_msgs
cdr_serialize(
  const orbbec_camera_msgs::srv::GetDeviceInfo_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  orbbec_camera_msgs::srv::GetDeviceInfo_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        orbbec_camera_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetDeviceInfo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        orbbec_camera_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetDeviceInfo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = orbbec_camera_msgs::srv::GetDeviceInfo_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        orbbec_camera_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetDeviceInfo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        orbbec_camera_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetDeviceInfo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const orbbec_camera_msgs::srv::GetDeviceInfo_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<orbbec_camera_msgs::srv::GetDeviceInfo_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_orbbec_camera_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<orbbec_camera_msgs::srv::GetDeviceInfo_Event>()
{
  return &orbbec_camera_msgs::srv::typesupport_fastrtps_cpp::_GetDeviceInfo_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orbbec_camera_msgs, srv, GetDeviceInfo_Event)() {
  return &orbbec_camera_msgs::srv::typesupport_fastrtps_cpp::_GetDeviceInfo_Event__handle;
}
...
static const rosidl_service_type_support_t _GetDeviceInfo__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<orbbec_camera_msgs::srv::GetDeviceInfo_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<orbbec_camera_msgs::srv::GetDeviceInfo_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<orbbec_camera_msgs::srv::GetDeviceInfo_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<orbbec_camera_msgs::srv::GetDeviceInfo>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<orbbec_camera_msgs::srv::GetDeviceInfo>,
