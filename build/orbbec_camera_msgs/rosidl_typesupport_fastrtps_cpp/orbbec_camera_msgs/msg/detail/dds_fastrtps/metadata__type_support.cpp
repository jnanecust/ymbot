...
#include "orbbec_camera_msgs/msg/detail/metadata__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const orbbec_camera_msgs::msg::Metadata & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  orbbec_camera_msgs::msg::Metadata & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = orbbec_camera_msgs::msg::Metadata;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const orbbec_camera_msgs::msg::Metadata *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<orbbec_camera_msgs::msg::Metadata *>(
    untyped_ros_message);
...
static rosidl_message_type_support_t _Metadata__handle = {
  ...
  &orbbec_camera_msgs__msg__Metadata__get_type_hash,
  &orbbec_camera_msgs__msg__Metadata__get_type_description,
  &orbbec_camera_msgs__msg__Metadata__get_type_description_sources,
};
...
get_message_type_support_handle<orbbec_camera_msgs::msg::Metadata>()
{
  return &orbbec_camera_msgs::msg::typesupport_fastrtps_cpp::_Metadata__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orbbec_camera_msgs, msg, Metadata)() {
  return &orbbec_camera_msgs::msg::typesupport_fastrtps_cpp::_Metadata__handle;
}
