...
#include "orbbec_camera_msgs/msg/detail/device_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const orbbec_camera_msgs::msg::DeviceInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  orbbec_camera_msgs::msg::DeviceInfo & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = orbbec_camera_msgs::msg::DeviceInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const orbbec_camera_msgs::msg::DeviceInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<orbbec_camera_msgs::msg::DeviceInfo *>(
    untyped_ros_message);
...
get_message_type_support_handle<orbbec_camera_msgs::msg::DeviceInfo>()
{
  return &orbbec_camera_msgs::msg::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orbbec_camera_msgs, msg, DeviceInfo)() {
  return &orbbec_camera_msgs::msg::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
