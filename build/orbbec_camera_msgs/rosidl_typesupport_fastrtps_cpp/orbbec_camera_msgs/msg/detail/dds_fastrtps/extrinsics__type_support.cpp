  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = orbbec_camera_msgs::msg::Extrinsics;
    is_plain =
      (
...
static rosidl_message_type_support_t _Extrinsics__handle = {
  ...
  &orbbec_camera_msgs__msg__Extrinsics__get_type_hash,
  &orbbec_camera_msgs__msg__Extrinsics__get_type_description,
  &orbbec_camera_msgs__msg__Extrinsics__get_type_description_sources,
};
