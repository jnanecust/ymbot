...
def generate_launch_description():
    ...
    servo_params_neck = {
        ...
        .yaml("config/ymbot_d_simulated_config_neck.yaml")
        .to_dict()
    }

    # This sets the update rate and planning group name for the acceleration limiting filter.
    acceleration_filter_update_period = {"update_period": 0.01}
    planning_group_name_neck = {"planning_group_name": "neck"}
    ...
    container = launch_ros.actions.ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            launch_ros.descriptions.ComposableNode(
                ...
                name="servo_node_neck",
                parameters=[
                    servo_params_neck,
                    acceleration_filter_update_period,
                    planning_group_name_neck,
                    moveit_config.robot_description,
                    moveit_config.robot_description_semantic,
    ...
    neck_control_node = launch_ros.actions.Node(
        package="ymbot_d_control",
        executable="delta_joint_tracking_neck",
        name="delta_joint_tracking_neck",
        output="screen",
    )
    ...
    return launch.LaunchDescription(
        [
            ...
            servo_node,
            container,
            launch.actions.TimerAction(period=8.0, actions=[neck_control_node]),
        ]
    )
