...
class IKServoNode_Coll(Node):
    ...
    def reset_cb(self, msg):
        ...
        #                             0.0, -0.523598776])
        reset_positions = np.array([0.1219919, 0.4297180, -0.3866274, -0.9153638, -0.0403485, 0.7866671, -0.1801998,
                                    -0.1283603, -0.4313776, 0.3824616, 0.9323392, 0.0389847, 0.7630228, 0.1806111,
                                    -0.610865238, 1.448623279, 1.186823891,   0.0,
                                    0.0, -0.959931])
