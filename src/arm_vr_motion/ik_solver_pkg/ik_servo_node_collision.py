...
class IKServoNode_Coll(Node):
    ...
    def reset_cb(self, msg):
        ...
        #                             0.0, -0.523598776])
        reset_positions = np.array([0.0349066, 0.3665191, -0.3665191, -0.6632251, 0.0, 1.0995574, -0.1919862,
                                    -0.0349066, -0.3665191, 0.3665191, 0.6632251, 0.0, 1.0995574, 0.1919862,
                                    -0.610865238, 1.448623279, 1.186823891,   0.0,
                                    0.0, -0.959931])
