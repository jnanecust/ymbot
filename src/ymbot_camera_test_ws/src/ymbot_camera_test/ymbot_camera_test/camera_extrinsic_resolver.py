...
class CameraExtrinsicResolver(Node):
    def __init__(self):
        ...
        self.body_to_optical_t = (
            self.declare_parameter("body_to_optical.x", 0.017001106478886134).value,
            self.declare_parameter("body_to_optical.y", -0.0010085308315865987).value,
            self.declare_parameter("body_to_optical.z", 0.32779437316292953).value,
        )
        self.body_to_optical_q = _normalize_quat((
            self.declare_parameter("body_to_optical.qx", -0.6290346561392619).value,
            self.declare_parameter("body_to_optical.qy", 0.6266029318530252).value,
            self.declare_parameter("body_to_optical.qz", -0.31472334246889455).value,
            self.declare_parameter("body_to_optical.qw", 0.33560897615254637).value,
        ))
