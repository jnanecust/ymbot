...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_format',      'default': 'Y8', 'description': 'color stream format'},
                           ...
                           {'name': 'depth_module.exposure',        'default': '11479', 'description': 'Depth module manual exposure value'},
                           ...
                           {'name': 'gyro_fps',                     'default': '30', 'description': "''"},
                           {'name': 'accel_fps',                    'default': '30', 'description': "''"},
