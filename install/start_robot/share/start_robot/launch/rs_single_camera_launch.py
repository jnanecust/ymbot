...
local_parameters = [{'name': 'camera_name1', 'default': 'cam_left_wrist', 'description': 'camera1 unique name'},
                    {'name': 'camera_namespace1', 'default': 'cam_left_wrist', 'description': 'camera1 namespace'},
                    {'name': 'serial_no1', 'default': "'218622275899'", 'description': 'choose device1 by serial number'},
                    ]
