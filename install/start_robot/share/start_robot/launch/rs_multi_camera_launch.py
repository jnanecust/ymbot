...
local_parameters = [{'name': 'camera_name1', 'default': 'left', 'description': 'camera1 unique name'},
                    {'name': 'camera_name2', 'default': 'right', 'description': 'camera2 unique name'},
                    {'name': 'camera_namespace1', 'default': 'left', 'description': 'camera1 namespace'},
                    {'name': 'camera_namespace2', 'default': 'right', 'description': 'camera2 namespace'},
                    {'name': 'serial_no1', 'default': "'352122273846'", 'description': 'choose device1 by serial number'},
                    {'name': 'serial_no2', 'default': "'352122273648'", 'description': 'choose device2 by serial number'} # camera_1_ID,camera_2_ID換成對應數字
                    ]
